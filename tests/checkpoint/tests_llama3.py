...
HF_LLAMA_8B_PATH = "/home/ext_kazuki_fujii_turing_motors_c/hf-checkpoints/Meta-Llama-3-8B"
HF_LLAMA_70B_PATH = "/home/ext_kazuki_fujii_turing_motors_c/hf-checkpoints/Meta-Llama-3-70B"


@pytest.mark.parametrize("tp", ["1", "2"])
@pytest.mark.parametrize("pp", ["1", "2"])
@pytest.mark.parametrize("hf_path", [HF_LLAMA_8B_PATH, HF_LLAMA_70B_PATH])
def test_llama_2_hf_megatron_hf(tp, pp, hf_path):
    with tempfile.TemporaryDirectory(
        dir="/home/ext_kazuki_fujii_turing_motors_c/tmp/megatron"
    ) as temp_dir_meg, tempfile.TemporaryDirectory(
        dir="/home/ext_kazuki_fujii_turing_motors_c/tmp/hf"
    ) as temp_dir_hf:
