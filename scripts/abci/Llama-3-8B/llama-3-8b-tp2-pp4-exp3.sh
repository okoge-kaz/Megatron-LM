...
# ja swallow
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 9679346409 /scratch/acf15649kv/Meta-Llama-3_original_transformers-4.40.1/split_0_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 9584155928 /scratch/acf15649kv/Meta-Llama-3_original_transformers-4.40.1/split_1_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 11431522821 /scratch/acf15649kv/Meta-Llama-3_original_transformers-4.40.1/split_2_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 15073924105 /scratch/acf15649kv/Meta-Llama-3_original_transformers-4.40.1/split_3_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 35052747941 /scratch/acf15649kv/Meta-Llama-3_original_transformers-4.40.1/split_4_text_document"
...
# en arxiv
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 4584050488 /scratch/acf15649kv/Meta-Llama-3_original_transformers-4.40.1/lumi_en_arxiv_merge_text_document"

# en refinedweb
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 4584050488 /scratch/acf15649kv/Meta-Llama-3_original_transformers-4.40.1/lumi_en_falcon_merge_text_document"
