...
#$ -l h_rt=3:15:00:00
#$ -j y
#$ -o outputs/Llama-3.1-swallow-8b-v0.2/
#$ -cwd
...
CHECKPOINT_SAVE_DIR=/bb/llm/gaf51275/2024/checkpoints/Llama-3.1-swallow-8b-v0.2/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}/LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}
