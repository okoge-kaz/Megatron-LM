...
CHECKPOINT_SAVE_DIR=/groups/gag51395/checkpoints/Llama-3-70b/ja8-en1-code1-exp2/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}/LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}
