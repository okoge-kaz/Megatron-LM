...
upload_base_dir=/bb/llm/gaf51275/2024/checkpoints/megatron-to-hf/Llama-3.1-8b-from-Instruct-ablation/exp1/tp4-pp1
...
for ((i = start; i <= end; i += increment)); do
  ...
  repo_name="tokyotech-llm/Llama-3.1-8B-ablation-${EXP}-LR2.5e-5-MINLR2.5E-6-WD0.1-iter$(printf "%07d" $i)"
