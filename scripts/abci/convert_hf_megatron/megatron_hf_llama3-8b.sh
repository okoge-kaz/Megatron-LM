...
# model config
MEGATRON_CHECKPOINT_DIR=/groups/gag51395/checkpoints/Llama-3-8b/ja_9-en_1/tp2-pp2-ct1/LR1.0e-5-MINLR1.0E-6-WD0.1
HF_CHECKPOINT_DIR=/groups/gag51395/checkpoints/megatron-to-hf/Llama-3-8b-hf/ja_9-en_1/LR1.0e-5-MINLR1.0E-6-WD0.1/iter_${FORMATTED_ITERATION}
