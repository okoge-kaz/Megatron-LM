...
# model config
MEGATRON_CHECKPOINT_DIR=/bb/llm/gaf51275/2024/checkpoints/Llama-3.1-8b-code/exp4/tp4-pp1-ct2/LR2.5E-5-MINLR2.5E-6-WD0.1

# tokenizer config
TOKENIZER_MODEL_DIR=/bb/llm/gaf51275/hf-checkpoints/Meta-Llama-3.1-8B

# hf checkpoint dir base
HF_CHECKPOINT_DIR_BASE=/bb/llm/gaf51275/2024/checkpoints/megatron-to-hf/Llama-3.1-8b-code-ablation/${EXP}/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}
...
for ITERATION in $(seq $START_ITERATION $STEP $END_ITERATION); do
  ...
  echo "saving to ${HF_CHECKPOINT_DIR}"
