...
CHECKPOINT_SAVE_DIR=/gs/bs/tga-NII-LLM/Llama-3-70B/exp6-fp8-delayed-scaling/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}-LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}
