...
HF_CHECKPOINT_DIR=/home/ext_kazuki_fujii_rio_gsic_titech/checkpoints/megatron-to-hf/Llama-2-70b-hf

mkdir -p ${HF_CHECKPOINT_DIR}

# tokenizer config
TOKENIZER_MODEL_DIR=/home/ext_kazuki_fujii_rio_gsic_titech/hf_checkpoints/Llama-2-70b-hf
